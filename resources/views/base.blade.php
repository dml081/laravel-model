<html lang="en"><head>
  ...
  <body class="">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad large bg-info block-1">
                ...
                <div class="swiper main-swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                  <div class="swiper-wrapper" id="swiper-wrapper-cf4bfc87e193a8fa" aria-live="polite">
                    
                    <div class="swiper-slide swiper-slide-active" style="width: 748px;" role="group" aria-label="1 / 3">
                    ...
                    <div class="swiper-slide swiper-slide-next" style="width: 748px;" role="group" aria-label="2 / 3">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                    ...
                    <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 748px;">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% natural</div>
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-5">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="swiper-buttons">
                  <button class="swiper-prev category-carousel-prev btn btn-yellow swiper-button-disabled" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-9a351f4245b663103" aria-disabled="true">❮</button>
                  <button class="swiper-next category-carousel-next btn btn-yellow" tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-9a351f4245b663103" aria-disabled="false">❯</button>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper swiper-initialized swiper-horizontal">
              <div class="swiper-wrapper" id="swiper-wrapper-9a351f4245b663103" aria-live="polite">
                <a href="index.html" class="nav-link category-item swiper-slide swiper-slide-active" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="1 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide swiper-slide-next" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="2 / 12">
                  <img src="images/icon-bread-baguette.png" alt="Category Thumbnail">
                  <h3 class="category-title">Breads &amp; Sweets</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="3 / 12">
                  <img src="images/icon-soft-drinks-bottle.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="4 / 12">
                  <img src="images/icon-wine-glass-bottle.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="5 / 12">
                  <img src="images/icon-animal-products-drumsticks.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="6 / 12">
                  <img src="images/icon-bread-herb-flour.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="7 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="8 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="9 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="10 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="11 / 12">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide" role="group" aria-label="12 / 12" style="width: 229.333px; margin-right: 30px;">
                  <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits &amp; Veges</h3>
                </a>
      ...
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap flex-wrap justify-content-between mb-5">
              ...
              <div class="d-flex align-items-center">
                <a href="#" class="btn-link text-decoration-none">View All Categories →</a>
                <div class="swiper-buttons">
                  <button class="swiper-prev brand-carousel-prev btn btn-yellow swiper-button-disabled" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-d00707d083d9646d" aria-disabled="true">❮</button>
                  <button class="swiper-next brand-carousel-next btn btn-yellow" tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-d00707d083d9646d" aria-disabled="false">❯</button>
                </div>  
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="brand-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-d00707d083d9646d" aria-live="polite">
                
                <div class="swiper-slide swiper-slide-active" style="width: 359px; margin-right: 30px;" role="group" aria-label="1 / 6">
                ...
                <div class="swiper-slide swiper-slide-next" style="width: 359px; margin-right: 30px;" role="group" aria-label="2 / 6">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                ...
                <div class="swiper-slide" style="width: 359px; margin-right: 30px;" role="group" aria-label="3 / 6">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                ...
                <div class="swiper-slide" style="width: 359px; margin-right: 30px;" role="group" aria-label="4 / 6">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                ...
                <div class="swiper-slide" style="width: 359px; margin-right: 30px;" role="group" aria-label="5 / 6">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/product-thumb-11.jpg" class="img-fluid rounded" alt="Card title">
                ...
                <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 359px; margin-right: 30px;">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="images/product-thumb-12.jpg" class="img-fluid rounded" alt="Card title">
    ...
    <section class="py-5 overflow-hidden">
      <div class="container-fluid" data-np-autofill-form-type="other" data-np-checked="1" data-np-watching="1">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-5">
              ...
              <div class="d-flex align-items-center">
                <a href="#" class="btn-link text-decoration-none">View All Categories →</a>
                <div class="swiper-buttons">
                  <button class="swiper-prev products-carousel-prev btn btn-primary swiper-button-disabled" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-44ea2bbb35a8514c" aria-disabled="true">❮</button>
                  <button class="swiper-next products-carousel-next btn btn-primary" tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-44ea2bbb35a8514c" aria-disabled="false">❯</button>
                </div>  
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="products-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-adeaf72265fa8a77" aria-live="polite">
                
                <div class="product-item swiper-slide swiper-slide-active" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="1 / 8">
                ...
                <div class="product-item swiper-slide swiper-slide-next" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="2 / 8">
                  <span class="badge bg-success position-absolute m-3">-15%</span>
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                ...
                <div class="product-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="3 / 8">
                  <span class="badge bg-success position-absolute m-3">-15%</span>
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                ...
                <div class="product-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="4 / 8">
                  <span class="badge bg-success position-absolute m-3">-15%</span>
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                ...
                <div class="product-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="5 / 8">
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/thumb-tomatoes.png" class="tab-image">
                ...
                <div class="product-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="6 / 8">
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/thumb-tomatoketchup.png" class="tab-image">
                ...
                <div class="product-item swiper-slide" style="width: 229.333px; margin-right: 30px;" role="group" aria-label="7 / 8">
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/thumb-bananas.png" class="tab-image">
                ...
                <div class="product-item swiper-slide" role="group" aria-label="8 / 8" style="width: 229.333px; margin-right: 30px;">
                  <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="images/thumb-bananas.png" class="tab-image">
        ...
        <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('images/bg-leaves-img-pattern.png') no-repeat;">
          <div class="container my-5">
            <div class="row">
              ...
              <div class="col-md-6 p-5">
                <form data-np-autofill-form-type="subscribe" data-np-checked="1" data-np-watching="1">
                  <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control form-control-lg" name="name" id="name" placeholder="Name" data-np-intersection-state="visible">
                  </div>
                  <div class="mb-3">
                    <label for="" class="form-label">Email</label>
                    <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="abc@mail.com" data-np-autofill-field-type="email">
                  </div>
      ...
      <div class="container-fluid" data-np-autofill-form-type="other" data-np-checked="1" data-np-watching="1">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="products-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-3b7fcc6fe84b972b" aria-live="polite">
      ...
      <div class="container-fluid" data-np-autofill-form-type="other" data-np-checked="1" data-np-watching="1">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="products-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
              <div class="swiper-wrapper" id="swiper-wrapper-44ea2bbb35a8514c" aria-live="polite">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              ...
              <form class="d-flex mt-3 gap-0" role="newsletter" data-np-autofill-form-type="subscribe" data-np-checked="1" data-np-watching="1">
                <input class="form-control rounded-start rounded-0 bg-light" type="email" placeholder="Email Address" aria-label="Email Address" data-np-autofill-field-type="email">
